...
## 2026.2.313
* Support multiple Twig template usage types per file for indexing (Daniel Espendiller)
* Introduce Twig template usage documentation for PHP and Twig files (Daniel Espendiller)
* Add route documentation popover for PHP and Twig templates (Daniel Espendiller)
* Add Symfony 8.1 HttpFoundation property write inspection (Daniel Espendiller)
* Add Symfony 8.1 Console input mode deprecation inspection (Daniel Espendiller)
* Add more explicit Vite configuration structure parsing (Daniel Espendiller)
* Add simple Reprise completion / navigation leveraging the exiting Vite bundle infrastructure (Daniel Espendiller)
* Support AsFormType and FormField attribute indexing (Daniel Espendiller)
* State that list_symfony_routes_url_controllers does not list controllers (Matthias Pigulla)
* handle symfony ux twig components / live components defined by tag on service (David Buchmann)
* Add Twig `enum()` type resolve (Daniel Espendiller)
* Add Find Usages support for data-class properties / methods in Symfony form fields (Daniel Espendiller)
* backport: Add Markdown support with Twig (Daniel Espendiller)
* Add support for identifying `getAllowedEnvs` method in Kernel classes using specific traits (Daniel Espendiller)
* Optimize mcp output as csv for tables (Daniel Espendiller)
* [paid] Inspect missing ConstraintViolationList findByCodes method (Daniel Espendiller)
* [paid] Inspect grouped ControllerEvent attributes deprecated in Symfony 8.1 (Daniel Espendiller)
* [paid] Add YAML from_callable option deprecation inspection (Daniel Espendiller)
* [paid] Add PHP tagged collection default method deprecation inspection (Daniel Espendiller)
* [paid] Add Filesystem mirror copy_on_windows deprecation inspection (Daniel Espendiller)
* [paid] Filter all Twig usage extensions by Symfony or Shopware license Centralize TwigFileUsage loading behind the existing Symfony/Shopware license checks. (Daniel Espendiller)
