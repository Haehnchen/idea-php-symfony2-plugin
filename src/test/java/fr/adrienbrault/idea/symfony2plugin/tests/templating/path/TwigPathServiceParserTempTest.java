...
public class TwigPathServiceParserTempTest extends SymfonyTempCodeInsightFixtureTestCase {
    ...
    public void testRelativePathWithNestedSymfonyRoot() throws Exception {
        ...
        assertEquals("symfony-app/src/Report/Resources/views", parser.getTwigPathIndex().getNamespacePaths("Report").get(0).getPath());
        assertEquals("symfony-app/templates", parser.getTwigPathIndex().getNamespacePaths(TwigUtil.MAIN).get(0).getPath());
    }
    ...
    public void testRelativePathFallbackSkipsNonExistentPath() throws Exception {
        ...
        assertEquals(0, parser.getTwigPathIndex().getNamespacePaths("Ghost").size());
    }
    ...
    public void testAbsolutePathWithoutKernelProjectDirIsSkipped() throws Exception {
        ...
        assertEquals(0, parser.getTwigPathIndex().getNamespacePaths("AbsoluteOnly").size());
    }
}
