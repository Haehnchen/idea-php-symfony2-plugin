...
class SymfonyFormTypeCollectorTest : McpCollectorTestCase() {
     ...
     */
    fun testCollectHasCorrectHeader() {
     ...
     */
    fun testCollectExportsStringLiteralFormType() {
        val result = SymfonyFormTypeCollector(project).collect()
     ...
     */
    fun testCollectExportsClassConstantFormType() {
        val result = SymfonyFormTypeCollector(project).collect()
     ...
     */
    fun testCollectExportsFormTypesFromMultipleFixtureFiles() {
        val result = SymfonyFormTypeCollector(project).collect()
