 ...
 */
class XmlDuplicateServiceKeyInspectionTest : SymfonyLightCodeInsightFixtureTestCase() {
    fun testDuplicateParameterKey() {
        assertLocalInspectionContains(XmlDuplicateServiceKeyInspection::class.java, "service.xml", "" +
