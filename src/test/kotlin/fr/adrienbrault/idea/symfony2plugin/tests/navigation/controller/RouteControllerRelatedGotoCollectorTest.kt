 ...
 */
class RouteControllerRelatedGotoCollectorTest : SymfonyLightCodeInsightFixtureTestCase() {
    override fun setUp() {
        super.setUp()
    ...
    fun testThatControllerProvidesYamDefinitionNavigation() {
        assertLineMarker(
            ...
            LineMarker.ToolTipEqualsAssert("foo_route_bar_foo"),
        )
        ...
        assertLineMarker(
            ...
            LineMarker.ToolTipEqualsAssert("foo_route_bar_bar_sequence"),
        )
    }

    fun testThatControllerProvidesPhpRoutingDefinitionNavigation() {
        ...
        assertLineMarker(
            ...
            LineMarker.ToolTipEqualsAssert("_profiler_home"),
        )
    }
}
