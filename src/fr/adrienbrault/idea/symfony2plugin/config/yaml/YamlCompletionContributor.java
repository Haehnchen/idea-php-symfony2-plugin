...
public class YamlCompletionContributor extends CompletionContributor {
    public YamlCompletionContributor() {
        ...
        extend(CompletionType.BASIC, YamlElementPatternHelper.getSuperParentArrayKey(3, "services"), new YamlCompletionProvider(new String[] {"class", "public", "tags", "calls", "arguments"}));
