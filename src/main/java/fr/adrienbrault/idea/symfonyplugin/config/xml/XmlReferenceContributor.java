...
import fr.adrienbrault.idea.symfonyplugin.config.ClassPublicMethodReference;
...
import fr.adrienbrault.idea.symfonyplugin.config.xml.provider.ServiceReferenceProvider;
