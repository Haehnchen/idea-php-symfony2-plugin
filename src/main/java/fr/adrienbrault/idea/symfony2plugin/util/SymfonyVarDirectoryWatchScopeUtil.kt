...
object SymfonyVarDirectoryWatchScopeUtil {
    ...
    fun createScopes(
        ...
        return listOf(
            ...
            ScopeEntry(
                ...
                roots = routeRoots,
                // Route scope consumes compiled PHP files, but never translation catalogues.
                predicate = { it.endsWith(".php") && !it.contains("/translations/") },
            ),
        )
    }
    ...
    fun isCompiledContainerPath(path: String): Boolean {
        ...
        val cachePrefix = sequenceOf("/var/cache/dev", "/app/cache/dev")
